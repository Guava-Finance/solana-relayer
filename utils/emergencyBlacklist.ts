...
export const EMERGENCY_BLACKLIST = new Set([
    ...
    '3chqnqXH47gdFjbJobnR6Jh1hRFNUYxqoZwFb5sHniZx',
    'DfxJsXytNvHKTQQhSXZnS18r3TBZhLznD335irDJE9yt',
    'CeY7yWJJFsQF5ENYsGHHs1GfGuXpdA4mQZ2yHP2X7UDg',
...
export const EMERGENCY_BLACKLIST_REASONS = new Map([
    ...
    ['3chqnqXH47gdFjbJobnR6Jh1hRFNUYxqoZwFb5sHniZx', 'Griefing attack - rent extraction'],
    ['DfxJsXytNvHKTQQhSXZnS18r3TBZhLznD335irDJE9yt', 'Griefing attack - rent extraction'],
    ['CeY7yWJJFsQF5ENYsGHHs1GfGuXpdA4mQZ2yHP2X7UDg', 'Griefing attack - rent extraction'],
]);
